...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmlraGlsMTgxOSIsImEiOiJjbHpxM284ZG0xZzVkMmlvY2dvaW95a2tjIn0.TYIszn71Kb3AfneG0A-jfA';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          if (_axios.default.isAxiosError(_context.t0)) {
            if (_context.t0.code === 'ERR_NETWORK') {
              (0, _alerts.showAlert)('error', 'Network error. Please check your connection.');
            } else if (_context.t0.response && _context.t0.response.data && _context.t0.response.data.message) {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message);
            } else {
              (0, _alerts.showAlert)('error', 'An error occurred while updating settings.');
            }
          } else {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripePublicKey = 'pk_test_51Ppdb1GoORHb9TiWy1pxEtpkAH0bZVmkQs0YJpB5WCjxLgHrtY53VlpFiK4COED8vv6UKaMsEjO8fk5Sj4hTWl1v00O1Z8PuKz';
var stripe = typeof Stripe !== 'undefined' ? Stripe(stripePublicKey) : null;
